...
from services.api.models_accounting import AccountingEntity, JournalEntry, JournalEntryLine, ChartOfAccounts
from services.api.models_tax import TaxProvision
...
class TaxProvisionService:
    ...
    async def create_provision_journal_entry(self, provision_id: int) -> int:
        ...
        from services.api.models_accounting import JournalEntry

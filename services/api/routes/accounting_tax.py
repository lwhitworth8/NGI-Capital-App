...
from services.api.models_tax import TaxPayment, TaxProvision, TaxReturn, TaxDeadline
from services.api.services.tax_provision_service import TaxProvisionService
...
async def create_tax_payment(
    ...
    try:
        ...
        tax_payment = TaxPayment(
            ...
            tax_year=int(payment.tax_period.split('-')[0]) if '-' in payment.tax_period else datetime.now().year,

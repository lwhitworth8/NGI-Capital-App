...
async def get_income_statement(
    ...
    try:
        ...
        logger.info(f"Generated income statement for entity {entity_id} by user: unknown")
...
async def get_balance_sheet(
    ...
    try:
        ...
        logger.info(f"Generated balance sheet for entity {entity_id} by user: unknown")
...
async def get_cash_flow_statement(
    ...
    try:
        ...
        logger.info(f"Generated cash flow statement for entity {entity_id} by user: unknown")
...
async def get_partner_capital_statement(
    ...
    try:
        ...
        logger.info(f"Generated partner capital statement for entity {entity_id} by user: unknown")
...
async def export_report(
    ...
    try:
        ...
        logger.info(f"Exported {export_request.report_type} for entity {export_request.entity_id} in {export_request.format} format by user: unknown")
...
async def get_reportable_entities(
    ...
    try:
        ...
        logger.info(f"Retrieved reportable entities for user: unknown")

...
class Partners(Base):
    ...
    # Relationships
    created_transactions = relationship("Transactions", foreign_keys="[Transactions.created_by_id]")
    approved_transactions = relationship("Transactions", foreign_keys="[Transactions.approved_by_id]")

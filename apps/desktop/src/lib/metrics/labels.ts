export const LABELS: Record<string, string> = {
  ...
  'EURUSD=X': 'EUR/USD (Euro ? U.S. Dollar)',
  'GBPUSD=X': 'GBP/USD (British Pound ? U.S. Dollar)',
  'USDJPY=X': 'USD/JPY (U.S. Dollar ? Japanese Yen)',
  'USDCAD=X': 'USD/CAD (U.S. Dollar ? Canadian Dollar)',
  'USDCHF=X': 'USD/CHF (U.S. Dollar ? Swiss Franc)',
  'AUDUSD=X': 'AUD/USD (Australian Dollar ? U.S. Dollar)',
  'CL=F': 'WTI Crude ($/bbl)',
  'GC=F': 'Gold ($/oz)',
  // FRED macros
  'DGS10': 'U.S. 10-Year Treasury Yield',
  'DGS2': 'U.S. 2-Year Treasury Yield',
  'T10Y2Y': '2s10s Spread (bp)',
  'UNRATE': 'Unemployment Rate',
  'CPIAUCSL': 'CPI (YoY)',
  'PCEPILFE': 'Core PCE (YoY)',
  'GDPC1': 'Real GDP (YoY)',
  'NAPM': 'ISM Manufacturing PMI',
  'HOUST': 'Housing Starts (SAAR)',
  // FRED 5y canonical
